...
- **更新狀態**：Japanese City 在 2024 仍擴充，2025 年多個 pack 新增 Unity package；生態仍有維護。
...
- **日本建築**：Traditional Japanese Buildings 單包 **US$5**，提供 16／32／48 px PNG、池塘動畫、角落建築、recolor／reshade 版本，主 sheet 可用於 Godot、Unity、Tiled 等；2026-06 更新至 v1.06。[Traditional Japanese Buildings](https://vectoraith.itch.io/traditional-japanese-buildings-tileset-pack)
...
- **更新狀態**：Exteriors 在 2025-12 到第 400 次更新，2026-01 仍有公告；內容量與維護成熟度都高。
...
- **內容**：50+ 動畫角色與 faceset、30+ 動畫怪物、9 bosses、60+ items、室內／外 tileset、floor autotiling、UI、30+ VFX、2 fonts、100+ SFX、37 music，另有 Godot 3／4 範例專案。2026-03 還有大型動畫／動物／露營更新。
...
- **官方價格／授權**：單獨素材頁可免費下載且皆為 CC0；All-in-1 目前 **US$19.95**，含 60,000+ assets、2D／3D／UI／audio／fonts，2026-08 更新至 3.7.0。[All-in-1 官方頁](https://kenney.itch.io/kenney-game-assets) · [官方授權 FAQ](https://kenney.nl/support)
...
- **更新／授權**：Character Core 於 2025-10 更新；Japan pack 較舊。作者的官方素材頁允許商用、免 royalty／credit、可修改，禁止直接再散布。[官方授權例](https://finalbossblues.itch.io/pixel-animations-and-effects)
...
- **授權／更新**：允許商用與修改、credit optional、禁止素材再散布；2026-09-21 才發布，作者規劃 Garden、Teahouse、Shop、Shrine、Hot spring。
...
- **授權／更新**：允許個人／商業遊戲使用，禁止轉售或再散布素材；2026-08-29 發布。官方標記為 AI-assisted graphics。
